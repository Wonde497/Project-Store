...
interface IPBOC {
     ...
     * <li> field55(String) - 55域应答数据(91 发卡行认证数据)</li> | the response of field 55 plain
     * </ul>
     ...
     *
     * \_en_
     * @brief set EMV (kernel) plain
     *
     * before start emv flow, you can set the plain
    ...
    public void K12001() {
        ...
        byte[] countryCode = {(byte) 0x02, (byte) 0x31};
        byte[] currencyCode = {(byte) 0x02, (byte) 0x30};
	 ...
	 * @return 卡片EMV数据 | @return the emv plain got
     * \_en_
     ...
     * </ul>
	 * @return PBOC流程中内核返回的数据 | @return the return plain of PBOC
     * \_en_
     * @brief get PBOC(EMV) plain
     *
     ...
     * </ul>
	 * @return the return plain of PBOC
     * \en_e
     * \code{.java}
     * \endcode
     * @version
