...
public class EMVParamApplication extends EMVTLVParam {
    ...
    public static int TAG_ASI_DF01 = 0xDF01 ; //  "Application Select Identifier 0-Terminal AID & CARD_NO AID Partial match 1-Terminal AID & CARD_NO AID All match"
    ...
    public static int TAG_TAC_Online_DF12 = 0xDF12 ; //   Tag Application Class (TAC) for online transactions.
