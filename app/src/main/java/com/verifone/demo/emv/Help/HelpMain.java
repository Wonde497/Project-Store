        ...
        listViewHelp.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (position == 0) {
                    ...
                    Intent intent = new Intent(HelpMain.this, HelpDetailedActivity.class);
                    intent.putExtra("title", selectedItem.getTitle());
                    helptitle = "How can I Login ?";
                    help_text = "default_login";
                    user_role = "default";
                    ...
                    help_text = "default_forgotpassword";
                    user_role = "default";
